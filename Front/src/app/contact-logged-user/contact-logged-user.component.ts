...
@Component({
  selector: 'app-contact-logged-user',
  templateUrl: './contact-logged-user.component.html',
  styleUrls: ['./contact-logged-user.component.scss']
})
export class ContactLoggedUserComponent implements OnInit{
  // @ts-ignore
  descInput: string
  // @ts-ignore
  descInput1: string
